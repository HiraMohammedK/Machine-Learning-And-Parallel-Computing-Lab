...
Original file is located at
    https://colab.research.google.com/drive/1x8XGEqTpx3KvIgRDDv9LGWBZErY4kJ3A
"""
...
model4 = SVC(kernel='rbf', C=1, gamma='scale', probability = True, random_state=42)
...
from sklearn.metrics import roc_auc_score
pred_prob = model4.predict_proba(X_test)
y_pred_lr= model4.predict_proba(X_test)
...
print_recalls_precision(recall, precision, "SVM")